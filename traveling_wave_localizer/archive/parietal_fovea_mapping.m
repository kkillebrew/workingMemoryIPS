...
options.cycle_duration     =   1;         % duration (sec) of a single cycle (eg, rotation period of wedge or ring). *** should be an increment of the TR ***
...
options.dots.fcoh  = 0.50;	        % fraction of coherent dots moving in same direction.  these dots change direction for peripheral target when using dots stimuli.
...
options.direction           = repmat({'bar'},1,8);        % cell array of strings, one for each run.  options are wedge:'cw','ccw'     ring:'in','out'     bar:'bar'

...
% stimulus timing
params.prefix_dur  = 16; % duration of prefixation time (before trial 1) in seconds
params.postfix_dur = 16; % duration of final fixation period (after last trial) in seconds
...
display(sprintf('   orientation performance = %.2f%%',perf.orientation.overall));
display(sprintf('   letters performance = %.2f%%',perf.letters.overall));
display(sprintf('*****************************************\n'));
